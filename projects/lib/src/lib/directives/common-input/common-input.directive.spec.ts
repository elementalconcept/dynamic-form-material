...
import { DynamicFormValidator } from '@elemental-concept/dynamic-form';
...
describe('CommonInputDirective', () => {
  ...
  it(
    'should set dynamicFormElement (1)',
    fakeAsync(() => {
      const directive = new CommonInputDirective();
      const element = {
        id: 'checkbox',
  ...
  it(
    'should set dynamicFormElement (2)',
    fakeAsync(() => {
      const directive = new CommonInputDirective();
      const element = {
        id: 'password',
